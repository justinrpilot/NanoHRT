...
def setupCustomizedAK8(process, runOnMC=False, path=None):
    ...
    process.customAK8Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            ...
            # DeepAK8: nominal
            nnTbcq=Var("userFloat('DeepBoostedJet:nn_Top_bcq')", float, doc="DeepAK8 score Top_bcq", precision=10),
            nnTbqq=Var("userFloat('DeepBoostedJet:nn_Top_bqq')", float, doc="DeepAK8 score Top_bqq", precision=10),
            nnTbc=Var("userFloat('DeepBoostedJet:nn_Top_bc')", float, doc="DeepAK8 score Top_bc", precision=10),
            nnTbq=Var("userFloat('DeepBoostedJet:nn_Top_bq')", float, doc="DeepAK8 score Top_bq", precision=10),
            nnWcq=Var("userFloat('DeepBoostedJet:nn_W_cq')", float, doc="DeepAK8 score W_cq", precision=10),
            nnWqq=Var("userFloat('DeepBoostedJet:nn_W_qq')", float, doc="DeepAK8 score W_qq", precision=10),
            nnZbb=Var("userFloat('DeepBoostedJet:nn_Z_bb')", float, doc="DeepAK8 score Z_bb", precision=10),
            nnZcc=Var("userFloat('DeepBoostedJet:nn_Z_cc')", float, doc="DeepAK8 score Z_cc", precision=10),
            nnZqq=Var("userFloat('DeepBoostedJet:nn_Z_qq')", float, doc="DeepAK8 score Z_qq", precision=10),
            nnHbb=Var("userFloat('DeepBoostedJet:nn_H_bb')", float, doc="DeepAK8 score nnHbb", precision=10),
            nnHcc=Var("userFloat('DeepBoostedJet:nn_H_cc')", float, doc="DeepAK8 score nnHcc", precision=10),
            nnHqqqq=Var("userFloat('DeepBoostedJet:nn_H_qqqq')", float, doc="DeepAK8 score nnHqqqq", precision=10),
            nnQCDbb=Var("userFloat('DeepBoostedJet:nn_QCD_bb')", float, doc="DeepAK8 score QCD_bb", precision=10),
            nnQCDcc=Var("userFloat('DeepBoostedJet:nn_QCD_cc')", float, doc="DeepAK8 score QCD_cc", precision=10),
            nnQCDb=Var("userFloat('DeepBoostedJet:nn_QCD_b')", float, doc="DeepAK8 score QCD_b", precision=10),
            nnQCDc=Var("userFloat('DeepBoostedJet:nn_QCD_c')", float, doc="DeepAK8 score QCD_c", precision=10),
            nnQCDothers=Var("userFloat('DeepBoostedJet:nn_QCD_others')", float, doc="DeepAK8 score QCD_others", precision=10),
            # DeepAK8: decorrelated
            nnMDTbcq=Var("userFloat('DeepBoostedJet:decorr_nn_Top_bcq')", float, doc="Mass-decorrelated DeepAK8 score Top_bcq", precision=10),
            nnMDTbqq=Var("userFloat('DeepBoostedJet:decorr_nn_Top_bqq')", float, doc="Mass-decorrelated DeepAK8 score Top_bqq", precision=10),
            nnMDTbc=Var("userFloat('DeepBoostedJet:decorr_nn_Top_bc')", float, doc="Mass-decorrelated DeepAK8 score Top_bc", precision=10),
            nnMDTbq=Var("userFloat('DeepBoostedJet:decorr_nn_Top_bq')", float, doc="Mass-decorrelated DeepAK8 score Top_bq", precision=10),
            nnMDWcq=Var("userFloat('DeepBoostedJet:decorr_nn_W_cq')", float, doc="Mass-decorrelated DeepAK8 score W_cq", precision=10),
            nnMDWqq=Var("userFloat('DeepBoostedJet:decorr_nn_W_qq')", float, doc="Mass-decorrelated DeepAK8 score W_qq", precision=10),
            nnMDZbb=Var("userFloat('DeepBoostedJet:decorr_nn_Z_bb')", float, doc="Mass-decorrelated DeepAK8 score Z_bb", precision=10),
            nnMDZcc=Var("userFloat('DeepBoostedJet:decorr_nn_Z_cc')", float, doc="Mass-decorrelated DeepAK8 score Z_cc", precision=10),
            nnMDZqq=Var("userFloat('DeepBoostedJet:decorr_nn_Z_qq')", float, doc="Mass-decorrelated DeepAK8 score Z_qq", precision=10),
            nnMDHbb=Var("userFloat('DeepBoostedJet:decorr_nn_H_bb')", float, doc="Mass-decorrelated DeepAK8 score nnHbb", precision=10),
            nnMDHcc=Var("userFloat('DeepBoostedJet:decorr_nn_H_cc')", float, doc="Mass-decorrelated DeepAK8 score nnHcc", precision=10),
            nnMDHqqqq=Var("userFloat('DeepBoostedJet:decorr_nn_H_qqqq')", float, doc="Mass-decorrelated DeepAK8 score nnHqqqq", precision=10),
            nnMDQCDbb=Var("userFloat('DeepBoostedJet:decorr_nn_QCD_bb')", float, doc="Mass-decorrelated DeepAK8 score QCD_bb", precision=10),
            nnMDQCDcc=Var("userFloat('DeepBoostedJet:decorr_nn_QCD_cc')", float, doc="Mass-decorrelated DeepAK8 score QCD_cc", precision=10),
            nnMDQCDb=Var("userFloat('DeepBoostedJet:decorr_nn_QCD_b')", float, doc="Mass-decorrelated DeepAK8 score QCD_b", precision=10),
            nnMDQCDc=Var("userFloat('DeepBoostedJet:decorr_nn_QCD_c')", float, doc="Mass-decorrelated DeepAK8 score QCD_c", precision=10),
            nnMDQCDothers=Var("userFloat('DeepBoostedJet:decorr_nn_QCD_others')", float, doc="Mass-decorrelated DeepAK8 score QCD_others", precision=10),
            # BEST Tagger
